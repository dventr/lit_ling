...
def save_html_with_font(fig, filepath, title=None):
    ...
    <style>
        body { font-family: 'Lato', sans-serif !important; background-color: #fafbfc; margin: 0; padding: 20px; }
        .js-plotly-plot, .plotly, text { font-family: 'Lato', sans-serif !important; }
